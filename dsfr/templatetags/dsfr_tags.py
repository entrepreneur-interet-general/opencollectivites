...
def dsfr_breadcrumb(breadcrumb_data: dict):
    """
...
def dsfr_callout(callout_data: dict):
    """
...
def dsfr_card(card_data: dict, extra_classes: str = "", new_tab: bool = False):
    """
...
def dsfr_input(input_data: dict, extra_classes: str = ""):
    """
...
def dsfr_pagination(context, page_obj):
    """
...
def dsfr_select(select_data: dict, extra_classes: str = ""):
    """
